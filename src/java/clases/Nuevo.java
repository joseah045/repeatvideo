    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String link = request.getParameter("link");
                    String url = "";
                    String urlcompleto = "";
                    String texto = "?loop=1&playlist=";
                    String urlrepetir = "";
                    if (link != null) {
                        String cadena = link.substring(32, link.length());
                        url = "https://www.youtube.com/embed/";
                        urlcompleto = url + cadena;
                        urlrepetir = urlcompleto + texto + cadena; }
                    request.setAttribute("urlrepetir", urlrepetir);
